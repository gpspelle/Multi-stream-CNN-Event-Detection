...
def main(learning_rate, mini_batch_size, batch_norm, weight_0, epochs): 
    ...
    for layer in layerscaffe[:-3]:
        ...
        K.set_value(layer_dict[layer].W, w2)
        K.set_value(layer_dict[layer].b, b2)
...
if __name__ == '__main__':
    # todo: changes ( That's not being used anymore )
    ...
    main(learning_rate, mini_batch_size, batch_norm, w0, epochs)
